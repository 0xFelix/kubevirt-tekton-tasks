module github.com/kubevirt/kubevirt-tekton-tasks/modules/create-datavolume-from-manifest
...
require (
	...
	kubevirt.io/containerized-data-importer v1.50.0
...
// KubeVirt
replace kubevirt.io/controller-lifecycle-operator-sdk/api => kubevirt.io/controller-lifecycle-operator-sdk/api v0.2.4
