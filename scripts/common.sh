...
export CREATE_DATAVOLUME_FROM_MANIFEST_IMAGE="${CREATE_DATAVOLUME_FROM_MANIFEST_IMAGE:-}"
IMAGE_MODULE_NAME_TO_ENV_NAME["create-datavolume-from-manifest"]="CREATE_DATAVOLUME_FROM_MANIFEST_IMAGE"
TASK_NAME_TO_IMAGE["create-datavolume-from-manifest"]="${CREATE_DATAVOLUME_FROM_MANIFEST_IMAGE}"
